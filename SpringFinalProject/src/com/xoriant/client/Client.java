...
/*	@RequestMapping(value="/hotel",method=RequestMethod.POST)
	...
	@RequestMapping("/lowToHigh/{id}")
	public ModelAndView getHotelsLowToHigh(@PathVariable("id") Integer id) {
		 ApplicationContext context = new ClassPathXmlApplicationContext("beans.xml");
		GuestDaoImpl guestDao = (GuestDaoImpl) context.getBean("UserDao");
	...
	@RequestMapping("/highToLow/{id}")
	public ModelAndView getHotelsHighToLow(@PathVariable("id") Integer id) {
		 ApplicationContext context = new ClassPathXmlApplicationContext("beans.xml");
		GuestDaoImpl guestDao = (GuestDaoImpl) context.getBean("UserDao");
	...
	@RequestMapping(value="/userBookingDetails/{id}",method=RequestMethod.POST)
	public ModelAndView getUserLoginDetails(@RequestParam("email") String email,@PathVariable("id") Integer id){
	...
	@RequestMapping(value="/viewHotel/{id}/{hotelId}",method=RequestMethod.GET)
	public ModelAndView getSelectedHotel(@PathVariable("id") Integer id,@PathVariable("hotelId") Integer hotelId){
	...
	public ModelAndView bookingSuccessful(@RequestParam("guestEmail") String guestEmail, 
				...
				@RequestParam("hotelEmail") String hotelEmail, @RequestParam("costPerDay") Double room_cost_perDay,
...
/*	@RequestMapping(value="/bookingSuccessful",method=RequestMethod.POST)
	...
	*/
	@RequestMapping(value="/searchHotels/{id}",method=RequestMethod.POST)
	public ModelAndView getCityDetails(@PathVariable("id") Integer id,@RequestParam("city") String city) {
		ApplicationContext context = new ClassPathXmlApplicationContext("beans.xml");
		GuestDaoImpl guestDao = (GuestDaoImpl) context.getBean("UserDao");
